...
const Header = () => {
  ...
  return (
    <>
                ...
                <div className="vl-main-menu">
                  <nav className="vl-mobile-menu-active">
                    <ul id="list-example">
                      ...
                      <li>
                        <a className="list-group-item list-group-item-action" href="#service">
                          Service
                        </a>
                      </li>
                      <li>
                        <a className="list-group-item list-group-item-action" href="#work">
                          Work
                        </a>
                      </li>
                      <li>
                        <a className="list-group-item list-group-item-action" href="#choose">
                          Choose Us
                        </a>
                      </li>
                      <li>
                        <a className="list-group-item list-group-item-action" href="#blog">
                          Blog
                        </a>
                      </li>
                    </ul>
                ...
                <div className="vl-header4-btns text-end d-none d-lg-block">
                  <div className="buttons">
                    <div className="vl-search1">
                      <button onClick={toggle} className="search-open-btn">
      ...
      <div className={`search__popup ${isOpen && 'search-opened'}`}>
        <Container>
          <Row>
            <Col xxl={12}>
