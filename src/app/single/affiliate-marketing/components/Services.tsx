...
const Services = () => {
  ...
  return (
    <>
      <div className="service7 pt-120 md:pt-50 sm:pt-50" id="service">
        <Container>
          <Row>
            <Col lg={4}>
              <div className="heading7">
                ...
                <div className="button mt-30">
                  <a href="/service" className="theme-btn13" data-aos="fade-left" data-aos-duration={800} data-aos-delay={300}>
                    View All Services
              ...
              <div className="cs_case_study_1_list md:mt-30 sm:mt-30">
                {servicesData.map((service, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`cs_case_study cs_style_1 cs_hover_active ${isActive ? 'active' : ''}`}
                      data-aos="fade-up"
