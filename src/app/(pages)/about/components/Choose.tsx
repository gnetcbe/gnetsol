          ...
          <Row>
            ...
            <Col lg={6}>
              <div className="about-choose-images ml-50 md:ml-0 sm:ml-0">
                <Row>
                  <Col md={6}>
                    <div className="image mt-30 mis1 image-anime reveal">
                      <Image className="w-full" src={image1} alt="g-net solutions -A global custom software development company" height={283} />
                    </div>
                    <div className="image mt-30 mis1 image-anime reveal">
                      <Image className="w-full" src={image2} alt="g-net solutions -A global custom software development company" height={283} />
                    </div>
                  </Col>
                  <Col lg={6}>
                    <div className="image image-anime mis1 reveal md:mt-30 sm:mt-30">
                      <Image className="w-full" src={image3} alt="g-net solutions -A global custom software development company" height={562} />
                    </div>
                  </Col>
                </Row>
              </div>
