...
<Col lg={8} md={4} xs={12}>
  <div className="vl-footer-widget-black6 mb-50 ml-70 md:ml-0 sm:ml-0">
    ...
    <div className="footer-tags-wrap">
      <Link href="">Website Design / Redesign</Link>
      <Link href="">E-Commerce / Shopping Cart</Link>
      <Link href="">Email Solutions</Link>
      <Link href="">Application Software</Link>
      <Link href="">Content Management Systems (CMS)</Link>
       <Link href="">Digital Marketing</Link>
      <Link href="">Website Maintenance and Support</Link>
      <Link href="">Webhosting and Domain Names</Link>
          ...
          <Row className="vl-copyright6 _dv-top align-items-center">
            ...
            <Col lg={6}>
              <div className="copyright-text right-side text-end sm:text-start md:text-start">
                ...
                <Link href="#" className="add-before">Privacy Policy</Link>
              </div>
            </Col>
          </Row>
        </Container>
