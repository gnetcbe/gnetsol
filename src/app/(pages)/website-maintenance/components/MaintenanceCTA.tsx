...
const MaintenanceCTA = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Build payload
    const formData = {
      name: (form.querySelector('input[placeholder="Your Full Name"]') as HTMLInputElement).value,
      company: (form.querySelector('input[placeholder="Company Name"]') as HTMLInputElement).value,
      email,
      phone: (form.querySelector('input[type="tel"]') as HTMLInputElement).value,
      website: (form.querySelector('input[type="url"]') as HTMLInputElement).value,
      hosting: (form.querySelector('input[placeholder*="Bluehost"]') as HTMLInputElement).value,
      services: Array.from(
        form.querySelectorAll('.checkbox-group input:checked')
      ).map((el) =>
        (el as HTMLInputElement).parentElement?.innerText.trim()
      ),
      frequency: (form.querySelector(
        'input[name="freq"]:checked'
      ) as HTMLInputElement)?.parentElement?.innerText.trim(),
      ...
      <Container>
        ...
        <form className="contact-form" onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            ...
            <div className="field">
              <label>Name</label>
              <input type="text" placeholder="Your Full Name" maxLength={50} required />
            </div>

            <div className="field">
              <label>Company Name (if any)</label>
              <input type="text" placeholder="Company Name" maxLength={60} />
            </div>
            ...
            <div className="field">
              ...
              <input type="url" placeholder="https://example.com" maxLength={100} />
            </div>

            <div className="field">
              <label>Hosting Provider (optional)</label>
              <input type="text" placeholder="e.g. Bluehost, SiteGround" maxLength={60} />
            </div>
            ...
            <div className="field">
              <label>Others</label>
              <input type="text" placeholder="Please specify" maxLength={100} />
            </div>

            <div className="field full">
              <label>Maintenance Frequency Preference:</label>
              <div className="radio-group">
                <label><input type="radio" name="freq" required /> One-time fix</label>
