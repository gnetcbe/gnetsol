...
import { default as logo, default as whiteLogo } from '@/assets/img/logo/white-logo.png'
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__text">Multi Page</span>
                                    ...
                                    <a href="/single/home" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__text">One Page</span>
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                      <span className="arrow2">
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <a className="text" href="/affiliate-marketing">
                                    02. Affiliate Marketing
                                  </a>
                                  <div className="btn-area1">
                                    <a href="/affiliate-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/affiliate-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <a href="/startups-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/startups-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <a href="/seo-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/seo-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <a href="/digital-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/digital-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <a href="/social-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/social-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <a className="text" href="/social-media-marketing">
                                    07. Social Marketing
                                  </a>
                                  <div className="btn-area1">
                                    <a href="/social-media-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/social-media-marketing" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <a href="/startup-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/startup-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <a className="text" href="/advertising-agency">
                                    09. Advertising Agency
                                  </a>
                                  <div className="btn-area1">
                                    <a href="/advertising-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/advertising-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <a className="text" href="/human-resources-agency">
                                    10. Human Resources
                                  </a>
                                  <div className="btn-area1">
                                    <a href="/human-resources-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                    ...
                                    <a href="/single/human-resources-agency" className="theme-btn11">
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
                                      <span className="theme-btn11__shape" />
