import img1 from '@/assets/img/about/about3-image1.png'
import img2 from '@/assets/img/about/about3-image2.png'
import span4 from '@/assets/img/icons/span4.svg'
import shape from '@/assets/img/shapes/about3-shape.png'
            ...
            <Col lg={6}>
              <div className="heading3 ml-40 sm:ml-0 md:ml-0 md:mt-30 sm:mt-30">
                <span className="sub-title" data-aos="zoom-in-left" data-aos-duration={900}>
                  <Image src={span4} alt="" /> ABOUT PRODUCT
                </span>
                <h2 className="text-anime-style-3">Innovative Branding Water Through Everyday Products</h2>
                <p className="mt-16" data-aos="fade-left" data-aos-duration={900}>
                  At SEOX Advertising Agency, we understand the power of unique branding. By transforming essential items like water bottles into
                  high-quality promotional products, we help businesses stand out and leave a memorable impression. Our expert team ensures every
                  design aligns perfectly with your brand vision.
                </p>
                <div className="about3-counters" data-aos="fade-left" data-aos-duration={1100}>
                  <Row>
                    <Col md={4} xs={6}>
                ...
                <div className="button mt-30" data-aos="fade-left">
                  <Link className="theme-btn5" href="/about">
                    Learn More
                  </Link>
                </div>
              </div>
