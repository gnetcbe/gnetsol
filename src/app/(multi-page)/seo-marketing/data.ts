...
export const blogData: BlogType[] = [
  {
    image: blog1,
    comment: '5 Essential Strategies For Consult Sustainable Of Business Growth',
    count: 1200,
  },
  {
    image: blog2,
...
export const workData: WorkType[] = [
  {
    ...
    comment: 'We start by understanding best you business needs, goals, challenges.',
    token: 'add-after',
  },
  {
    number: 2,
    ...
    comment: 'Our best design custom blockchain architecture developed secure app',
    token: 'add-after',
  },
  {
    number: 3,
