...
import { default as whitelogo, default as whiteLogo } from '@/assets/img/logo/white-logo.png'
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn8">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__text">Multi Page</span>
                                    </Link>
                                    <a href="/single/home" className="theme-btn8">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__text">One Page</span>
                                    </a>
                                  </div>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/affiliate-marketing">
                                      <div>
                                        <span className="theme-btn8__shape" />
                                        <span className="theme-btn8__shape" />
                                        <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/affiliate-marketing">
                                      One Page
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/startups-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/startups-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/seo-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/seo-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/digital-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/digital-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/social-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/social-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/social-media-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/social-media-marketing">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/startup-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/startup-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/advertising-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/advertising-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn8" href="/human-resources-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                    ...
                                    <Link className="theme-btn8" href="/single/human-resources-agency">
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
                                      <span className="theme-btn8__shape" />
