import footer1 from '@/assets/img/bg/footer4-bg.jpg'
...
const Footer = () => {
  return (
    <>
      <footer className="vl-footer-area4 bg-cover" style={{ backgroundImage: `url(${footer1.src})` }}>
            ...
            <Row>
              <Col xl={4} lg={4} md={6} sm={6}>
                <div className="vl-footer-widget-white vl-footer1-logo-area mr-50 mb-50">
                  ...
                  <div className="vl-footer-social4 text-start mt-20">
                    <Link href="">
              ...
              <Col lg={2} md={6} xs={12}>
                <div className="vl-footer-widget-white4 mb-50 ml-20 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={3} md={4} xs={6}>
                <div className="vl-footer-widget-white4 mb-50 ml-70 md:ml-0 sm:ml-0">
                  <h4>Category List</h4>
                  <div className="vl-footer-list">
                    <ul>
                      <li>
              ...
              <Col lg={3} md={8} sm={6}>
                <div className="vl-footer-contact4 vl-footer-widget-white mb-50 sm:ml-0 md:ml-0">
        ...
        <Container>
          <Row className="vl-copyright4 _dv-top align-items-center">
            <Col lg={6}>
