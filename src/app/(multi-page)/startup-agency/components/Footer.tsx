...
const Footer = () => {
  return (
    <>
      <footer className="vl-footer-area10">
        <div className="footer-bottom-content">
          <Container>
            <Row>
              ...
              <Col lg={2} md={6} xs={6}>
                <div className="vl-footer-widget-black10 mb-50 ml-20 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={3} md={4} xs={6}>
                <div className="vl-footer-widget-black10 mb-50 ml-70 md:ml-0 sm:ml-0">
                  <h4>Category List</h4>
                  <div className="vl-footer-list">
                    <ul>
                      <li>
              ...
              <Col lg={3} md={8} sm={6}>
                <div className="vl-footer-contact10 vl-footer-widget-black6 mb-50 sm:ml-0 md:ml-0">
        ...
        <Container>
          <Row className="vl-copyright10 _dv-top align-items-center">
            <Col lg={6}>
