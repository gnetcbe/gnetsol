                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn19">
                                      Multi Page{' '}
                                    ...
                                    <a href="/single/home" className="theme-btn19">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/affiliate-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/affiliate-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/startups-agency">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/startups-agency">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/seo-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/seo-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/digital-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/digital-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/social-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/social-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/social-media-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/social-media-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/startup-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/startup-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/advertising-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/advertising-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn19" href="/human-resources-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn19" href="/single/human-resources-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
              ...
              <Col lg={3} md={6} xs={6} className="">
                <div className="vl-header8-btns text-end d-none d-lg-block">
                  <div className="buttons">
                    ...
                    <div>
                      <Link href="/service" className="theme-btn19">
                        Grow Social Media
                        <span className="arrow1">
                          <FaArrowRight className="fa-solid" />
                        </span>
