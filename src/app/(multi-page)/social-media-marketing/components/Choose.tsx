      ...
      <div className="choose2 sp">
        <Container>
          <Row>
                ...
                <div className="choose2-apps">
                  <Row>
                    {chooseData.map((item, idx) => (
                      <Col lg={6} key={idx} data-aos="fade-up" data-aos-duration={900} data-aos-delay={item.duration}>
            ...
            <Col lg={6}>
              <div className="choose2-images ml-40 sm:ml-0 md:ml-0 sm:mt-30 md:mt-30">
