        ...
        <div id="vl-header-sticky" className={`vl-header-area2 header-tranperent header-${scrollY > 100 && 'sticky'}`}>
          <Container className="header2-bg">
            <Row className="align-items-center">
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn3">
                                      Multi Page{' '}
                                    ...
                                    <Link href="/single/home" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/affiliate-marketing" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/affiliate-marketing" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/startups-agency" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/startups-agency" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/seo-marketing" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/seo-marketing" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/digital-marketing" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/digital-marketing" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/social-marketing" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/social-marketing" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/social-media-marketing" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/social-media-marketing" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/startup-agency" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/startup-agency" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/advertising-agency" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/advertising-agency" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/human-resources-agency" className="theme-btn3">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link href="/single/human-resources-agency" className="theme-btn3">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
              ...
              <Col lg={3} md={6} xs={6}>
                <div className="vl-header2-btns text-end d-none d-lg-block">
                  <div className="buttons">
                    <div className="vl-search2">
