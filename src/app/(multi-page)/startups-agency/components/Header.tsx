                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn10">
                                      Multi Page{' '}
                                    ...
                                    <a href="/single/home" className="theme-btn10">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/affiliate-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/affiliate-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/startups-agency">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/startups-agency">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/seo-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/seo-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/digital-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/digital-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/social-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/social-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/social-media-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/social-media-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/startup-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/startup-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/advertising-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/advertising-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn10" href="/human-resources-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn10" href="/single/human-resources-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
