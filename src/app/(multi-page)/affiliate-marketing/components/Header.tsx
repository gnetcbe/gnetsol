        ...
        <div id="vl-header-sticky" className={`vl-header-area7 header-tranperent header-${scrollY > 100 && 'sticky'}`}>
          <Container className="header2-bg">
            <Row className="align-items-center">
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home" className="theme-btn13">
                                      Multi Page{' '}
                                    ...
                                    <a href="/single/home" className="theme-btn13">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/affiliate-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/affiliate-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/startups-agency">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/startups-agency">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/seo-marketing">
                                      Multi Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/seo-marketing">
                                      One Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/digital-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/digital-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/social-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/social-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/social-media-marketing">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/social-media-marketing">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/startup-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/startup-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/advertising-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/advertising-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn13" href="/human-resources-agency">
                                      Multi Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                                    ...
                                    <Link className="theme-btn13" href="/single/human-resources-agency">
                                      One Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
              ...
              <Col lg={3} md={6} xs={6}>
                <div className="vl-header7-btns text-end d-none d-lg-block">
              ...
              <div className="search__wrapper">
                <div className="search__top d-flex justify-content-between align-items-center">
                  ...
                  <div className="search__close">
                    <button onClick={toggle} type="button" className="search__close-btn search-close-btn">
