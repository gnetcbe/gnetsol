...
import logos from '@/assets/img/logo/black-logo.png'
...
const Footer = () => {
  return (
    <>
      <footer className="vl-footer-area1">
            ...
            <Row>
              <Col lg={8} className="m-auto text-center">
                <div className="heading7">
                  ...
                  <div className="cta7-form">
                    <input type="email" placeholder="Enter Your Email" />
                    <div className="button">
                      <button type="submit" className="theme-btn13">
                        Subscribe
        ...
        <div className="footer-bottom-content">
          <Container>
            <Row className="">
              ...
              <Col lg={2} md={6} xs={6}>
                <div className="vl-footer-widget-black7 mb-50 ml-20 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={3} md={4} xs={6}>
                <div className="vl-footer-widget-black7 mb-50 ml-70 md:ml-0 sm:ml-0">
                  <h4>Category List</h4>
                  <div className="vl-footer-list">
                    <ul>
                      <li>
              ...
              <Col lg={3} md={8} sm={6}>
                <div className="vl-footer-contact7 vl-footer-widget-black6 mb-50 sm:ml-0 md:ml-0">
        ...
        <Container>
          <Row className=" vl-copyright7 _dv-top align-items-center">
            <Col lg={6}>
