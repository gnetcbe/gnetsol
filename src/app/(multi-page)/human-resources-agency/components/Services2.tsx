        ...
        <Container>
          ...
          <Row className="mt-30">
            ...
            {serviceData.map((item, idx) => (
              <Col lg={4} md={6} key={idx} data-aos="zoom-in-up" data-aos-duration={1000}>
                <div className="service4-box mt-30">
                  ...
                  <div className="heading4 ">
                    ...
                    <Link href="/single-service/details1" className="learn text-16 leading-16 font-semibold title1">
                      Read More
                      <span className="arrow1"><FaArrowRight className="fa-solid" /></span>
                      <span className="arrow2"><FaArrowRight className="fa-solid" /></span>
                    </Link>
                  </div>
                </div>
              </Col>
            ...
            {serviceData2.map((item, idx) => (
              <Col lg={6} md={6} key={idx} data-aos="zoom-in-up" data-aos-duration={800}>
                <div className="service4-box mt-30">
